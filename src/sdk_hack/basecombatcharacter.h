...
#ifndef BASECOMBATCHARACTER_HACK_H
#define BASECOMBATCHARACTER_HACK_H
...
public:
	...
	int	  GetDamageCount(void);	// # of times NPC has been damaged.  used for tracking 1-shot kills.
...
public:
	...
	virtual CNavArea *GetLastKnownArea(void) const;		// return the last nav area the player occupied - NULL if unknown
	...
	#ifdef TF_DLL
	virtual int GetBossType() const = 0;
	#endif

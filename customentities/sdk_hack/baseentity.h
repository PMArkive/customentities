...
#ifndef BASEENTITY_HACK_H
#define BASEENTITY_HACK_H
#ifdef _WIN32
#pragma once
#endif
...
public:
	...
	#ifdef TF_DLL
	virtual bool ShouldForceTransmitsForTeam(int) = 0;
	virtual bool IsTruceValidForEnt() const = 0;
	virtual float GetDefaultItemChargeMeterValue() const = 0;
	#endif
};
